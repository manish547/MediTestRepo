...
import PackagePricingCancerScreening from './PackagePricingCancerScreening'
import AddOnCancerScreening from './AddOnCancerScreening'
import { pageContentData } from '@/api/PageContentApi'

const CancerScreening = ({ siteData }: { siteData: any }) => {
    ...
    <div>
      <div>
        ...
        <div className="container mx-auto my-6 px-3 sm:px-5">
          <PackagePricingCancerScreening siteData={siteData} />
        </div>
        <div className="container py-6 mx-auto my-6 md:py-0 px-3 sm:px-0">
          <AddOnCancerScreening siteData={siteData} />
        </div>
