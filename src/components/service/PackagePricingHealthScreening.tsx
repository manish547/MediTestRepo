...
import PackageCompareHealthScreening from './PackageCompareHealthScreening';
import parse from 'html-react-parser';

const PackagePricingHealthScreening = ({ siteData }: { siteData: any }) => {
    ...
    // const packageData2 = packageData[packageData.length - 2]
                ...
                {isPackageSelected ? (
                    <>
                        <div className="bg-gradient-to-b from-[#E4EFE1] to-transparent pt-10 md:py-10 md:px-16 w-full h-full max-w-[970px] flex-wrap md:flex-nowrap gap-10 rounded-[26px] flex justify-between items-center md:items-stretch font-Nunito relative">
                            ...
                            <div className="relative px-5 mt-6 md:mt-0 items-center md:items-baseline flex flex-col justify-between gap-10 w-full bg-gradient-to-b from-[#004A42] to-[#419886]  md:absolute md:-right-32 lg:right-20  md:max-w-[280px] md:gap-8  md:-translate-y-24 md:translate-x-8 p-8 md:p-[2.50rem] rounded-[20px] shadow-[0px_42px_34px_0px_#ABAFC799]">
...
export default PackagePricingHealthScreening